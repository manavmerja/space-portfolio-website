...
export default function Strands({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      program.uniforms.uResolution.value = [width * currentDpr, height * currentDpr];
      renderTarget.setSize(width * currentDpr, height * currentDpr);
      glassProgram.uniforms.uResolution.value = [width * currentDpr, height * currentDpr];
    }
