...
export default function FooterSection() {
  ...
  const links = [
    ...
    { title: "LinkedIn", icon: <IconBrandLinkedin className="h-full w-full text-blue-400" />, href: "https://www.linkedin.com/in/merja-manav-124ba7317/" },
    { title: "GitHub", icon: <IconBrandGithub className="h-full w-full text-white" />, href: "https://github.com/manavmerja" },
    { title: "Twitter", icon: <IconBrandX className="h-full w-full text-gray-300" />, href: "https://x.com/manavmerja" },
    { title: "Resume", icon: <IconFileText className="h-full w-full text-yellow-400" />, href: "/resume.pdf" },
    { title: "Email", icon: <IconMail className="h-full w-full text-green-400" />, href: "mailto:manavmerja@gmail.com" },
  ];
